/**
 * 《中华人民共和国个人信息保护法》全文（结构化）
 *
 * 来源：中国人大网（国家法律法规数据库）公布文本，8 章 74 条。
 * 核对依据：2021-08-20 第十三届全国人大常委会第三十次会议通过，2021-11-01 施行。
 *
 * 结构：章 → 条。每条的 paras 是数组，因为不少条文有多个自然段/款项，
 * 分段渲染更接近正式文本的排版，也便于阅读。
 */

export const PIPL_META = {
  title: '中华人民共和国个人信息保护法',
  passed:
    '（2021 年 8 月 20 日第十三届全国人民代表大会常务委员会第三十次会议通过）',
  effective: '自 2021 年 11 月 1 日起施行',
  source: '文本来源：中国人大网 · 国家法律法规数据库',
}

/**
 * 法律条文与本 App 功能的对应关系。
 * 让用户知道自己行使权利时点哪里，而不是只看到一堆条文。
 */
export const PIPL_RIGHTS_MAP = [
  {
    title: '查阅、复制与可携带权',
    article: '第四十五条',
    desc: '你有权查阅、复制你的个人信息，并请求将其转移至你指定的处理者。',
    feature: '对应「导出规划书 PDF」「导出预算数据 CSV」',
  },
  {
    title: '删除权',
    article: '第四十七条',
    desc: '处理目的已实现、你撤回同意或我们停止服务等情形下，你有权请求删除你的个人信息。',
    feature: '对应「注销账号并删除数据」',
  },
  {
    title: '知情与告知',
    article: '第十七条',
    desc: '处理你的个人信息前，我们应以显著、清晰易懂的方式告知处理目的、方式、种类与保存期限。',
    feature: '对应「查看隐私政策」',
  },
  {
    title: '便捷的行使权利渠道',
    article: '第五十条',
    desc: '我们应提供便捷的权利行使受理机制；拒绝你的请求时应说明理由。',
    feature: '对应「帮助与反馈」',
  },
]

export const PIPL_CHAPTERS = [
  {
    title: '第一章　总　则',
    articles: [
      {
      ...
      {
        no: '第二条',
        paras: ['自然人的个人信息受法律保护，任何组织、个人不得侵害自然人的个人信息权益。'],
      },
      {
        no: '第三条',
        paras: [
  ...
  },
  {
    ...
    articles: [
      ...
      {
        no: '第四十八条',
        paras: ['个人有权要求个人信息处理者对其个人信息处理规则进行解释说明。'],
      },
      {
        no: '第四十九条',
        paras: [
  ...
  },
  {
    ...
    articles: [
      ...
      {
        no: '第七十四条',
        paras: ['本法自 2021 年 11 月 1 日起施行。'],
      },
    ],
  },
]

export default { PIPL_META, PIPL_RIGHTS_MAP, PIPL_CHAPTERS }
